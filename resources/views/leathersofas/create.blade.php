...
@section('content')
<div class="container">
    <h2>create leathersofa</h2>
    {!! Form::open(['action'=>'leathersofasController@store','method'=>'POST','enctype'=> 'multipart/form-data']) !!}
            
            <div class="form-group">
                {{Form::label('name','leathersofa name')}}
                {{Form::Text('name' ,'',['class'=>'form-control','placeholder'=>'leathersofa name'])}}
            </div>            
            <div class="form-group">
            ...
            <div class="form-group">
                <div class="col-lg-10 col-lg-offset-2">
                    {{Form::submit('Create leathersofa', ['class'=>'btn btn-primary'])}}
