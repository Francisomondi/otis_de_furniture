...
@section('content')
<div class="container">
    <h2>create Bedroom Furniture</h2>
    {!! Form::open(['action'=>'bedroomsController@store','method'=>'POST','enctype'=> 'multipart/form-data']) !!}
            
            <div class="form-group">
                {{Form::label('name','Dinning name')}}
                {{Form::Text('name' ,'',['class'=>'form-control','placeholder'=>'Bedroom furniture name'])}}
            </div>            
            <div class="form-group">
            ...
            <div class="form-group">
                <div class="col-lg-10 col-lg-offset-2">
                    {{Form::submit('Create bedroom', ['class'=>'btn btn-primary'])}}
