...
@section('content')
<div class="container">
    <h2>create Dinning</h2>
    {!! Form::open(['action'=>'dinningsController@store','method'=>'POST','enctype'=> 'multipart/form-data']) !!}
            
            <div class="form-group">
                {{Form::label('name','Dinning name')}}
                {{Form::Text('name' ,'',['class'=>'form-control','placeholder'=>'Dinning name'])}}
            </div>            
            <div class="form-group">
            ...
            <div class="form-group">
                <div class="col-lg-10 col-lg-offset-2">
                    {{Form::submit('Create Dinning', ['class'=>'btn btn-primary'])}}
